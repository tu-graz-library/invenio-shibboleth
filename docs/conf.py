...
g = {}
with open(
    os.path.join(os.path.dirname(__file__), "..", "invenio_shibboleth", "version.py"),
    "rt",
) as fp:
    exec(fp.read(), g)
...
latex_documents = [
    (
        master_doc,
        "invenio-shibboleth.tex",
        u"invenio-shibboleth Documentation",
        u"CERN",
        "manual",
    ),
]
...
man_pages = [
    (master_doc, "invenio-shibboleth", u"invenio-shibboleth Documentation", [author], 1)
]
