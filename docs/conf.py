...
htmlhelp_basename = 'invenio-shibboleth_namedoc'
...
latex_documents = [
    (master_doc, 'invenio-shibboleth.tex', u'invenio-shibboleth Documentation',
     u'CERN', 'manual'),
]
...
man_pages = [
    (master_doc, 'invenio-shibboleth', u'invenio-shibboleth Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'invenio-shibboleth', u'invenio-shibboleth Documentation',
     author, 'invenio-shibboleth', 'Invenio module module that provides SAML integration.',
     'Miscellaneous'),
]
